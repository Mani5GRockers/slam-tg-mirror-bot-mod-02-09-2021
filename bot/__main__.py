...
botcmds = [
        ...
        (f'{BotCommands.MirrorCommand}', 'New User Start XXX Mirroring'),
        (f'{BotCommands.TarMirrorCommand}','Start XXX mirroring Magnet link, Direct link, Telegram files .zip and .tar more etc.'),
        (f'{BotCommands.UnzipMirrorCommand}','XXX Extract files'),
        (f'{BotCommands.CloneCommand}','XXX Copy file/folder to Drive'),
        (f'{BotCommands.CountCommand}','XXX Count file/folder of Drive link'),
        (f'{BotCommands.DeleteCommand}','Delete file from Drive'),
        (f'{BotCommands.WatchCommand}','Mirror Youtube-dl support link'),
        (f'{BotCommands.TarWatchCommand}','Mirror Youtube playlist link as .tar or .zip'),
        (f'{BotCommands.CancelMirror}','Cancel a task'),
        (f'{BotCommands.CancelAllCommand}','Cancel all tasks'),
        (f'{BotCommands.ListCommand}','XXX Searches files in Drive'),
        (f'{BotCommands.StatusCommand}','Get XXX Mirror Status message'),
        (f'{BotCommands.StatsCommand}','XXX Bot Usage Stats'),
        (f'{BotCommands.PingCommand}','Ping the Bot'),
        (f'{BotCommands.RestartCommand}','Restart the bot [owner/sudo only]'),
        (f'{BotCommands.LogCommand}','Get the Bot Log [owner/sudo only]'),
        (f'{BotCommands.TsHelpCommand}','Torrent Search Name XXX')
    ]
